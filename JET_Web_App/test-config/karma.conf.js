...
module.exports = function(config) {
  config.set({
    ...
    files: [   
      // Adding source files as they need to be served so tests can load them
    {
      pattern: 'src/js/**/*.js',      // Your source code
      included: false,
      watched: true
    },
      ...
      // Test files
      {
        pattern: 'src/js/__tests__/*.spec.js',
        included: false
      },
      // // CCA libs
      // { 
    ...
    preprocessors: {
     // 'src/**/__tests__/*.js': ['karma-typescript'],
